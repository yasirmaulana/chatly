...
class ChatService
{
    ...
    public function parseUserIntent(string $message): array
    {
        ...
        - "query_type": "sale" jika disebutkan penjualan atau sales, "stock" jika disebutkan stok atau stock.
        - Jika disebutkan angka tertentu, isi amount dengan angka itu, dan set flag jika perlu.
        - Jika disebutkan quantity atau jumlah unit atau stok, isi quantity dengan angka itu, dan set flag jika perlu.
